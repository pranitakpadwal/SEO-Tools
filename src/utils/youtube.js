...
export async function fetchChannelVideos(channelId, apiKey, maxResults = 50) {
  const searchUrl = `https://www.googleapis.com/youtube/v3/search?channelId=${channelId}&part=snippet&type=video&maxResults=${maxResults}&order=date&key=${apiKey}`
